...
import { ProfilesTable, UsersTable, StateTable, DriverTable , AddressTable ,CommentTable , StatusCatalogTable , OrderMenuItemTable , OrdersTable , OrderStatusTable , RestaurantOwnerTable , RestaurantTable  , CategoryTable ,MenuItemTable , CityTable } from "./schema";
import { TIUser, TSUser, TIProfile, TSProfile , TSState } from "./schema";
...
async function main() {
    ...
    console.log("CategoryMenuTable:");
    const categories = await getCategories();
    console.log(categories);

    console.log("MenuItemTable:");
